...
export async function getAboutContent() {
  ...
  return {
    heading: "About Paddu's Glam Haven",
    subtitle: "Creating timeless beauty with a modern touch.",
    portrait: null,
    bio: [
      "Prerna Annapantula, the artist behind Paddu's Glam Haven, has been passionate about dance and makeup from a very young age - dancing before she could even walk. Her love for makeup began through classical dance, where she first learned to do her own makeup and soon became the go-to artist in greenrooms for fellow dancers as well.",
      "Since middle school Prerna has specialized in classical dance makeup and has done on to work on multple Rangapraveshams, performances, and bridal events.",
    ],
    stats: [
